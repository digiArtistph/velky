<div>
	<p>Your are editing station id: No. <?php echo $office[0]->p_id;?></p>
	...
	<?php echo form_open( base_url() . 'master/police/validateupdateoffice' );?>
		...
		<p><label>Station: </label><input type="text" name="station" value="<?php echo $office[0]->station;?>" /><span><?php echo form_error('station'); ?></span></p>
