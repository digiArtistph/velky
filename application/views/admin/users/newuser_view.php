<div class="toolbar">
    ...
    <?php echo form_open("master/users/validatenewuser"); ?>
            ...
            <p><label>Middle Name</label> <input type="text" value="<?php echo set_value('mname'); ?>" name="mname" /><?php echo display_error('mname'); ?></p>
            ...
            <p><label>Access Level</label> <input type="text" value="<?php echo set_value('utype'); ?>" name="utype" /><?php echo display_error('utype'); ?></p>
