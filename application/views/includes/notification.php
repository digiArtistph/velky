<div class="modal hide fade" id="accidentNewMsgs">
                    ...
                    <div class="modal-footer">
                        <a href="<?php echo base_url('accident/accident'); ?>" class="btn ext_disabled">Go to accident report entry form</a>
                    </div>
                </div>
<div class="modal hide fade" id="entitiesResponses">
                    <div class="modal-header">
                        <button class="close" data-dismiss="modal">×</button>
